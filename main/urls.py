...
from main.views import show_main, add_item, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user, inc_amount, dec_amount, delete_item 
from . import views
